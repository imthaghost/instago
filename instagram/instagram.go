...
type Client struct {
	...
	AccessToken      string // AccessToken is the Instagram access token
	InstagramVersion string // InstagramVersion is the current version of instagram

	// Services for communicating with different parts of the api
	common  service // Reuse a single struct instead of allocating one for each service on the heap.
	Dsiplay *DisplayService
}
...
// NewClient New will create a new instance of the library
func NewClient(token string, httpClient *http.Client) *Client {
	...
	// Setup services
	c.Dsiplay = (*DisplayService)(&c.common)
